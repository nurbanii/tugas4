	...
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="assets/img/1.1.jpg" class="d-block w-100" alt="assets/img/1.jpg">
			</div>
			<div class="carousel-item">
				<img src="assets/img/1.2.jpg" class="d-block w-100" alt="assets/img/1.jpg">
			</div>
			<div class="carousel-item">
				<img src="assets/img/1.3.jpg" class="d-block w-100" alt="assets/img/1.jpg">
			</div>
		</div>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="card-feature">
						<i class="material-icons">Penjualan Terbanyak</i>
				...
				<div class="col-md-4">
					<div class="card-feature">
						<i class="material-icons">Pengiriman Cepat</i>
				...
				<div class="col-md-4">
					<div class="card-feature">
						<i class="material-icons">Kualitas Terbaik</i>
		...
		<div class="container">
			<div class="row">
				...
				while ($data  = mysqli_fetch_array($mysq)) {
					...
					<div class="col-md-4">
						<div class="card">
							<img src="assets/img/1.1.jpg" class="card-img-top" alt="...">
							<div class="card-body">
